...
function RepoRow({ repo, isActive, focusKey, onSelect, onInstall, onDelete }) {
    ...
    return (
        ...
        >
            {/* Name / select cell */}
            <div className={[
                'flex items-center gap-3 flex-1 min-w-0 rounded-lg px-3 h-10 transition-all',
            ...
            {/* Install button */}
            <div className={['flex items-center justify-center w-10 h-10 rounded-lg bg-indigo-700 text-white flex-shrink-0 transition-all', ring(COL_INSTALL)].join(' ')}>
